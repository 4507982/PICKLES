...
def calculate_bmi():
    ...
    if bmi<18.5:
        msg="u are under weight EAT MORE PICKLES"

    elif bmi>18.5 and bmi<=24.9:
        msg = "(normal range) U AREE SOOOO MEDIUM"

    elif bmi>25 and bmi<=29.9:
        msg = "GO TOUCH GRASS U OVERWEIGHT AHH"

    elif bmi>30:
        msg = "obeise STOP EATING U GOOFY AH"

    else:
        msg = "YO U BROKE THE APP SOMTHIN WENT WRONG FIX IT"
